...
function Handle_Operator(Next_Operator) {
    ...
    //When an operator key is pressed we convert the current number displayed on the screen into a number and then store the result in Calculator.First_Operand if it doesn't already exist.
